...
#include <stdlib.h>
#include "globals.hpp"// NULL, malloc, free, atoi
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    {
        if (ImGui::BeginMenu("Menu foooooo"))
        {
            ShowExampleMenuFile();
            ImGui::EndMenu();
        }
 ...
 //   ImGui::Text("dear imgui says hello");
      static int selected = -1;
            ...
            ImGui::Selectable("Print the graphics", &globe.drawFlag);

            //if (globe.drawFlag == true) { std::cout << globe.drawFlag << std::endl; globe.drawFlag = 0; }
